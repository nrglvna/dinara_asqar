      ...
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper_otzyv">
        <SwiperSlide className='app__otzyv__swiper'>
          ...
          <div className="app__otzyv__swiper__content">
            ...
            <div><h3>Сеитова Гумисгул</h3>
              <h4><AiFillInstagram/>mary_target04</h4>
            </div> 
          </div>
        ...
        <SwiperSlide className='app__otzyv__swiper'>
          ...
          <div className="app__otzyv__swiper__content">
            ...
            <h4><AiFillInstagram/>marzhan_arapbayeva</h4>
            </div>
        ...
        <SwiperSlide className='app__otzyv__swiper'>
          ...
          <div className="app__otzyv__swiper__content">
            ...
            <h4><AiFillInstagram/>gulzer.nurbolatovna</h4>
            </div>
          </div>
        ...
        <SwiperSlide className='app__otzyv__swiper'>
          ...
          <div className="app__otzyv__swiper__content">
            ...
            <h4><AiFillInstagram/>egeubaeva.aidana</h4>
            </div>
          </div>
        ...
        <SwiperSlide className='app__otzyv__swiper'>
          ...
          <div className="app__otzyv__swiper__content">
            ...
            <h4><AiFillInstagram/>ulzhan.turlybek</h4>
            </div>
          </div>
