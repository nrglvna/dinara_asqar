...
const Intro = () => {
  ...
  <div className="bagdarlama_container app__bg">
    <div className='bagdarlama app_wrapper_bg'>
      ...
      />
      <ShowMore
        taqyryp='5-ші модуль: ИДЕЯСЫҢ МИДЫ ҚОЗҒАҒАН'
      ...
      />
      <ShowMore
        taqyryp='7-ші модуль: САЙТПЕН САТУ'
      ...
      />
      <ShowMore
        taqyryp='8-ші модуль: БЛОКИРОВКА - ФОБИЯ ЕМЕС'
      ...
      />
      <ShowMore
        taqyryp='11-ші модуль: КЛИЕНТ ТАБУ КАНАЛДАРЫ'
